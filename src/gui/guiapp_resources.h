...
#define GX_STRING_ID_NOMBRE_PROYECTO 1
#define GX_STRING_ID_DUTY_CYCLE 2
#define GX_STRING_ID_SPEED 3
#define GX_STRING_ID_SW_VERSION 4
#define GX_STRING_ID_HW_VERSION 5
#define GX_STRING_ID_PROGRAMADORES 6
#define GX_STRING_ID_CONTROL_VEL 7
#define GX_STRING_ID_PROGRAMMER1 8
#define GX_STRING_ID_PROGRAMMER2 9
#define GX_STRING_ID_PROGRAMMER3 10
#define GX_STRING_ID_PERCENTAGE 11
#define GX_STRING_ID_RPM 12
#define GX_STRING_ID_STRING_2 13
#define GX_STRING_ID_SETPOINT 14
