...
GX_CONST GX_UBYTE display_1_NOMBRE_PROYECTO_English[21] = "Nombre del proyecto:";
GX_CONST GX_UBYTE display_1_DUTY_CYCLE_English[12] = "Duty cycle:";
GX_CONST GX_UBYTE display_1_SPEED_English[7] = "Speed:";
GX_CONST GX_UBYTE display_1_SW_VERSION_English[12] = "SW Version:";
GX_CONST GX_UBYTE display_1_HW_VERSION_English[12] = "HW Version:";
GX_CONST GX_UBYTE display_1_PROGRAMADORES_English[16] = "Programadores: ";
GX_CONST GX_UBYTE display_1_CONTROL_VEL_English[22] = "Control Vel. Motor CD";
GX_CONST GX_UBYTE display_1_PROGRAMMER1_English[16] = "De Jesus, Lloen";
GX_CONST GX_UBYTE display_1_PROGRAMMER2_English[16] = "Alvarado, Jorge";
GX_CONST GX_UBYTE display_1_PROGRAMMER3_English[15] = "Montoya, Edgar";
GX_CONST GX_UBYTE display_1_PERCENTAGE_English[2] = "%";
GX_CONST GX_UBYTE display_1_RPM_English[4] = "RPM";
GX_CONST GX_UBYTE display_1_STRING_2_English[2] = "0";
GX_CONST GX_UBYTE display_1_SETPOINT_English[10] = "Setpoint:";
GX_CONST GX_UBYTE display_1_STRING_1_English[6] = "99999";
GX_CONST GX_UBYTE display_1_STRING_3_English[5] = "9999";
...
{
    GX_NULL,
    display_1_NOMBRE_PROYECTO_English,
    display_1_DUTY_CYCLE_English,
    display_1_SPEED_English,
    display_1_SW_VERSION_English,
    display_1_HW_VERSION_English,
    display_1_PROGRAMADORES_English,
    display_1_CONTROL_VEL_English,
    display_1_PROGRAMMER1_English,
    display_1_PROGRAMMER2_English,
    display_1_PROGRAMMER3_English,
    display_1_PERCENTAGE_English,
    display_1_RPM_English,
    display_1_STRING_2_English,
    display_1_SETPOINT_English,
