...
#define ID_WINDOW1 1
#define ID_DUTY_CYCLE 2
#define ID_SPEED 3
#define ID_HW_VERSION 4
#define ID_PROGRAMADORES 5
#define ID_NOMBRE_PROYECTO 6
#define ID_CONTROL_VEL 7
#define ID_PROGRAMMER1 8
#define ID_PRROGRAMMER2 9
#define ID_PROGRAMMER3 10
#define ID_PERCENTAGE 11
#define ID_DUTY_VALUE 12
#define ID_SPEED_VALUE 13
#define ID_SW_VER_VALUE 14
#define ID_HW_VER_VALUE 15
#define ID_RPM 16
#define ID_SETPOINT 17
#define ID_RPM2 18
#define ID_SETPOINT_VALUE 19
...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window1_duty_cycle;
    GX_PROMPT window1_speed;
    GX_PROMPT window1_sw_version;
    GX_PROMPT window1_hw_version;
    GX_PROMPT window1_programadores;
    GX_PROMPT window1_nombre_proyecto;
    GX_PROMPT window1_Control_vel;
    GX_PROMPT window1_programmer1;
    GX_PROMPT window1_programmer2;
    GX_PROMPT window1_programmer3;
    GX_PROMPT window1_percentage;
    GX_PROMPT window1_duty_value;
    GX_PROMPT window1_speed_value;
    GX_PROMPT window1_sw_ver_value;
    GX_PROMPT window1_hw_ver_value;
    GX_PROMPT window1_rpm;
    GX_PROMPT window1_setpoint;
    GX_PROMPT window1_rpm2;
    GX_PROMPT window1_setpoint_value;
